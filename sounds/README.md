...
- `mouse.mp3` - Mouse squeaking
- `purr.mp3` - Cat purring
- `crinkle.mp3` - Crinkle/rustling sounds (like a bag or paper)
- `toy.mp3` - Squeaky toy sounds
- `hiss.mp3` - Cat hissing
- `treats.mp3` - Treat bag shaking
...
- Treat bag shakes
- Can opener
- Crinkle sounds from bags or paper
